// Project Timeline Update Email Template
// Same header/footer as project created template (Editorial Style)
...
export const timelineUpdateEmailTemplate = (
  projectTitle: string,
  ...
  const completedDate = formatDate(timelineEntry.completedAt);
...
<title>${studioData.name} - Project Update</title>
</head>
...
Your project,<br/>
<span style="color:${primary};font-style:italic;">moving forward.</span>
</h1>
...
Here's the latest progress we'd like to share with you.
</p>

</td>
</tr>
<!-- TIMELINE UPDATE CARD (Title, Description, Status) -->
<tr>
            ...
            <tr>
              <td style="padding:8px 6px;vertical-align:top;">
                ...
                <p style="margin-top:4px;
                  ...
                  color:#111;
                  line-height:1.5;">
                  ${timelineEntry.description || "Milestone completed successfully."}
                </p>
              </td>
            </tr>

            <!-- Status - Your Project is in State of [status] -->
            ...
            <tr>
              <td style="padding:8px 6px;vertical-align:top;">
                ...
                <p style="margin-top:4px;
                  ...
                  font-weight:600;
                  color:#111;">
                  Your project is in state of <span style="color:${primary};font-weight:700;">${timelineEntry.status}</span>
                </p>
              </td>
            </tr>
            ` : ''}
...
<tr>
  <td style="padding:20px 24px 8px 24px;">
    ...
    <p style="margin:0;
      ...
      line-height:1.6;
      max-width:480px;">
      We're committed to delivering exceptional results and will keep you informed every step of the way.
...
Description: ${timelineEntry.description || "Milestone completed successfully."}
${timelineEntry.status ? `Your project is in state of ${timelineEntry.status}\n` : ""}
Completed on: ${completedDate}

Best regards,
The ${studioData.name} Team`,
  };
};
